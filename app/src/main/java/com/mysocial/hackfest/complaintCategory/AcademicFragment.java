...
public class AcademicFragment extends Fragment implements RecyclerAdapter.ComplaintSelected {
    ...
    public AcademicFragment (Context context , List<Data> complaintList,String type)
    {
